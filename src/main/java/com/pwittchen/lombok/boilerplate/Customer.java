...
public class Customer {
    ...
    public Customer(int id, String name, String surname, String phone, String email, String address, List<String> products) {
        this.id = id;
        this.name = name;
    ...
    public static class CustomerBuilder {
        ...
        public Customer.CustomerBuilder id(int id) {
            this.id = id;
            return this;
        }
        ...
        public Customer.CustomerBuilder products(List<String> products) {
            this.products = products;
            return this;
        }

        public Customer build() {
            return new Customer(this.id, this.name, this.surname, this.phone, this.email, this.address, this.products);
        }

        public String toString() {
            return "Customer.CustomerBuilder(id=" + this.id + ", name=" + this.name + ", surname=" + this.surname + ", phone=" + this.phone + ", email=" + this.email + ", address=" + this.address + ", products=" + this.products + ")";
        }
    }
}